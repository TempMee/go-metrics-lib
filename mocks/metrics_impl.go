...
// CountMetricWithValue mocks base method.
func (m *MockMetricsImpl) CountMetricWithValue(name string, value int64, labels map[string]string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountMetricWithValue", name, value, labels)
	ret0, _ := ret[0].(error)
	return ret0
}

// CountMetricWithValue indicates an expected call of CountMetricWithValue.
func (mr *MockMetricsImplMockRecorder) CountMetricWithValue(name, value, labels any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountMetricWithValue", reflect.TypeOf((*MockMetricsImpl)(nil).CountMetricWithValue), name, value, labels)
}
