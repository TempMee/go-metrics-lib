...
// CountWithValue mocks base method.
func (m *MockClient) CountWithValue(metric string, value int64, labels map[string]string, rate float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountWithValue", metric, value, labels, rate)
	ret0, _ := ret[0].(error)
	return ret0
}

// CountWithValue indicates an expected call of CountWithValue.
func (mr *MockClientMockRecorder) CountWithValue(metric, value, labels, rate any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountWithValue", reflect.TypeOf((*MockClient)(nil).CountWithValue), metric, value, labels, rate)
}
